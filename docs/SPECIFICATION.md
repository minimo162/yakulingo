...
class AppSettings:
    ...
    local_ai_model_path: str = "local_ai/models/HY-MT1.5-1.8B.IQ4_XS.gguf"
...
> **Note**: ローカルAIの既定翻訳モデルは `local_ai/models/HY-MT1.5-1.8B.IQ4_XS.gguf`。使用するモデルは `local_ai_model_path` で指定する。
