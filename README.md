...
```json
{
  ...
  "request_timeout": 600,
  "max_retries": 3,
  "local_ai_model_path": "local_ai/models/mistralai_Ministral-3-14B-Instruct-2512-IQ3_XXS.gguf",
...
| `local_ai_model_path` | ローカルAIモデル（.gguf）のパス | `local_ai/models/mistralai_Ministral-3-14B-Instruct-2512-IQ3_XXS.gguf` |
