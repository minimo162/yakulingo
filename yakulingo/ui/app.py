...
TEXT_TRANSLATION_CHAR_LIMIT = 5000  # Max chars for text translation (Ctrl+Shift+J, Ctrl+Enter)
...
class YakuLingoApp:
    ...
    def __init__(self):
        ...
        # Hotkey manager for quick translation (Ctrl+Shift+J)
    ...
    def start_hotkey_manager(self):
        """Start the global hotkey manager for quick translation (Ctrl+Shift+J)."""
        import sys
        ...
        try:
            ...
            logger.info("Hotkey manager started (Ctrl+Shift+J)")
