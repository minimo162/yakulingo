...
class AppSettings:
    ...
    local_ai_model_path: str = "local_ai/models/HY-MT1.5-7B.i1-Q6_K.gguf"
...
> **Note**: ローカルAIの既定翻訳モデルは `local_ai/models/HY-MT1.5-7B.i1-Q6_K.gguf`。使用するモデルは `local_ai_model_path` で指定する。
