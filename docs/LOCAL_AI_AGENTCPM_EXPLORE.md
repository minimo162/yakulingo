...
## 現行仕様（重要）
- ローカルAIの既定翻訳モデル: `mradermacher/translategemma-12b-it-i1-GGUF/translategemma-12b-it.i1-IQ4_XS.gguf`
- 配置先（既定）: `local_ai/models/translategemma-12b-it.i1-IQ4_XS.gguf`
