...
@pytest.mark.unit
def test_calculate_side_panel_window_widths_ultrawide_keeps_half_split() -> None:
    screen_width = 2560
    ...
    assert edge_width == available_width // 2
    assert app_width == available_width - edge_width
