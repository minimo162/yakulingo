...
| 05 | DONE | UI表示（戻し訳/パス）を整理し、設定UIの選択肢を更新 | `case-yakulingo-disable-backtranslation-double-prompt-20260201-075708-05-ui-cleanup` | `a415da79` |
| 06 | DONE | 統合リグレッション（typecheck/lint/full tests）と仕上げ | `case-yakulingo-disable-backtranslation-double-prompt-20260201-075708-06-regression` | `4bd1c418` |
