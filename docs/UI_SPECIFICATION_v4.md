...
│  │ glossary.csv                                   │            │
│  └────────────────────────────────────────────────┘            │
│  Custom terms for consistent translation                        │
│                                                                 │
│  ─────────────────────────────────────────────────────────────  │
│                                                                 │
│  Output                                                         │
│  ☐ Add language suffix to filename (_EN, _JP)                   │
...
|---------|------|---------|-------------|
| Glossary file | File path | `glossary.csv` | Custom term mappings |
| Add suffix | Checkbox | ✓ On | Add `_EN` or `_JP` to output filename |
| Create backup | Checkbox | ☐ Off | Keep copy of original file |
