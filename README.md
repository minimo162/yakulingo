...
5. 翻訳後に追加リクエスト
   - **英訳時**: [もう少し短く] / [より詳しく] / [他の言い方は？] の調整ボタン + 「アレンジした英文をチェック」入力欄で再調整
...
| `embed_glossary_in_prompt` | 用語集をプロンプトに埋め込む | true |
...
**用語集埋め込み**: `embed_glossary_in_prompt`をtrueにすると、用語集をプロンプトに直接埋め込み、翻訳が高速化されます（約16〜19秒短縮）。
