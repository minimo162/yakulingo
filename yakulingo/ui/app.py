...
def _detect_display_settings(
    ...
    **重要: DPIスケーリングの影響**
    ...
    MIN_SIDEBAR_WIDTH = 360   # Increased for wider sidebar
...
(function() {
    ...
    const SIDEBAR_RATIO = 360 / 1800;
    const INPUT_PANEL_RATIO = 400 / 1800;
    const MIN_SIDEBAR_WIDTH = 360;  // Increased for wider sidebar
